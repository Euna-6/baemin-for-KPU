	...
	<div class="menu_list">
		<ul class="tabs">
  		...
  		<div id="tab-1" class="tab-content current">
  			<form action="order.jsp" method="post">
  				<sql:query var="rs" dataSource="jdbc/mysql">
					select menuName, menuPrice from menu where foodType="chicken"
				</sql:query>
				<table class="menu">
  		...
  		<div id="tab-2" class="tab-content" style="text-align:left;">
  			<form action="http://localhost:8080/euna_free/ReviewServlet?cmd=reviewAdd&foodType=chicken" method="post">
			...
			<div class="reviewTab">
				<sql:query var="rs" dataSource="jdbc/mysql">
					select nickname, content from review where foodType="chicken"
				</sql:query>
				<c:forEach var="row" items="${rs.rows}">
